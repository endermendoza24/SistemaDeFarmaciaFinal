...
$(document).ready(function () {
    ...
    var cod = document.getElementById('IdCategoria'); //  el id del modal
    if (cod.value > 0) {
        $('#MiModal').modal('show');
    }
...
function Limpiar() {
    ...
    var nomcat = document.getElementById('NombreCategoria');
    var desccat = document.getElementById('Descripcion');
...
function loadDataTable() {
    datatable = $('#TblDatos').DataTable({
        ...
        "columns": [
            { "data": "idCategoria", "width": "10%" }, //se deben escribir a como estan en la base de datos, exceptuando si van separados por guion bajo, en ese caso no se debe de poner el guion
            { "data": "nombreCategoria", "width": "20%" },
